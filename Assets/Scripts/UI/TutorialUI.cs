...
public class TutorialUI : MonoBehaviour {
    ...
    [SerializeField] private TextMeshProUGUI keyMoveUpGamepadInteractText;
    [SerializeField] private TextMeshProUGUI keyMoveUpGamepadInteractAlternateText;
    ...
    private void UpdateVisual() {
        ...
        keyMoveUpGamepadInteractText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_Interact);
        keyMoveUpGamepadInteractAlternateText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_InteractAlternate);
